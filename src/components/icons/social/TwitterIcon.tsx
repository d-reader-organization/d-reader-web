...
export const TwitterIcon = React.forwardRef<SVGSVGElement, SvgIconProps>((props, ref) => (
  <svg ref={ref} {...props} viewBox='0 0 16 16' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
    <path
