...
export const GoogleLogoIcon = React.forwardRef<SVGSVGElement, SvgIconProps>(({ className, ...props }, ref) => (
  <svg ref={ref} {...props} className={className} viewBox='0 0 21 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
    <mask
      id='mask0_4228_14601'
