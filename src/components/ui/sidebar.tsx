...
>(({ side = 'left', variant = 'sidebar', collapsible = 'offcanvas', className, children, ...props }, ref) => {
  ...
  if (collapsible === 'none') {
    return (
      <div
        className={cn('flex h-full w-[--sidebar-width] flex-col bg-grey-500 text-sidebar-foreground', className)}
        ref={ref}
        {...props}
      >
        {children}
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-mobile='true'
          className='w-[--sidebar-width] bg-grey-500 p-0 text-sidebar-foreground [&>button]:hidden'
          style={
            {
